    ...
    <transition name="move" mode="in-out">
      <div class="main_bg" v-show="contentShow || !!!highSettings.command">
        ...
        <div class="main">
         ...
         <audio id="bgMusic" src="//pic.ibaotu.com/mp3Watermark_v3/00/28/75/f1c4537cf59ebbb0b13e15bcb9d17c2a.mp3"></audio>
         <audio id="bgMusicS" src="//pic.ibaotu.com/01/07/68/3888piCN888piCaKe.mp3"></audio>
        <div class="btn" @click="draw">
          
            <!-- <embed src="//pic.ibaotu.com/mp3Watermark_v3/00/28/75/f1c4537cf59ebbb0b13e15bcb9d17c2a.mp3" id="aa" style="width:20px"> -->
            {{drawDesc}}
            <!-- <embed src="//pic.ibaotu.com/01/07/68/3888piCN888piCaKe.mp3" id="bb" style="display:none"> -->
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      draw() {
        ...
        var musicS = document.getElementById("bgMusicS");
        if (this.drawTime % 2 === 0) {
          ...
          this.drawDesc = '开始抽奖';
          // this.$alert('<div style="width:1365px; height:500px;background:url(http://img.51miz.com/Element/00/59/45/30/a8669b2b_E594530_6f1830a5.jpg!/quality/90/unsharp/true/compress/true/format/jpg);background-size:cover;bacground-repeat:repeat;"><h2 class="numberH">'+number+'<h2></div>', {
  ...
  // 背景http://img.51miz.com/Element/00/59/21/47/cde54d4b_E592147_d314bbfd.jpg!/quality/90/unsharp/true/compress/true/format/jpg
</script>
<style lang="stylus" rel="stylesheet/stylus">
  .main-wrapper
    ...
    .main_bg
      ...
      background: url('./index/bg2.png') top center no-repeat
  ...
  @media screen and (max-width: 1366px)
    .main-wrapper
      ...
      .main_bg
        box-sizing: border-box
        background: url('./index/bg2.png') cover
        height: 769px
        .main
          margin: 0 auto
          width: 1000px
